...
export default function Home() {
  ...
  return (
    ...
    <main className="flex flex-col bg-pink-500 gap-[32px] row-start-2 items-center sm:items-start">
        <div className="bg-blue-500 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-3 w-full font-mono text-xs">
        ...
        <ol className="font-mono list-inside list-decimal text-sm/6 text-center sm:text-left">
          <li className="mb-2 tracking-[-.01em]">
            blegh Welcome to the ChatGPT Apps SDK Next.js Starter
          </li>
          <li className="mb-2 tracking-[-.01em]">
            THe Name returned from tool call: {name ?? "..."}
          </li>
