    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <SummaryCard
          images={[]}
          title="Bestreads"
          subtitle="Bestreads is a tool that allows you to search for books and get information about them"
          badge="55"
          badgeVariant="success"
          description="Bestreads is a tool that allows you to search for books and get information about them"
